    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="cover overlay">
                <img src="<?php echo base_url()?>site/images/profile-cover.jpg" alt="cover" />
            ...
            <div class="timeline row" data-toggle="gridalicious">
                ...
                <div class="timeline-block">
                    <div class="panel panel-default relative">
                        <img src="<?php echo base_url()?>site/images/place2-full.jpg" alt="place" class="img-responsive">
                        ...
                        <div class="panel-body">
                            <img src="<?php echo base_url()?>site/images/people/50/guy-2.jpg" alt="people" class="img-circle" />
                            <img src="<?php echo base_url()?>site/images/people/50/woman-2.jpg" alt="people" class="img-circle" />
                            <img src="<?php echo base_url()?>site/images/people/50/guy-3.jpg" alt="people" class="img-circle" />
                            <img src="<?php echo base_url()?>site/images/people/50/woman-3.jpg" alt="people" class="img-circle" />
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="media">
                                <a href="" class="pull-left">
                                    <img src="<?php echo base_url()?>site/images/people/50/woman-5.jpg" class="media-object">
                                </a>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="timeline-added-images">
                                <img src="<?php echo base_url()?>site/images/social/100/1.jpg" width="80">
                                <img src="<?php echo base_url()?>site/images/social/100/2.jpg" width="80">
                                <img src="<?php echo base_url()?>site/images/social/100/3.jpg" width="80">
                            </div>
                        </div>
                        ...
                        <ul class="comments">
                            <li>
                                <div class="media">
                                    <a href="" class="pull-left">
                                        <img src="<?php echo base_url()?>site/images/people/50/guy-5.jpg" class="media-object">
                                    </a>
                                    <div class="media-body">
                ...
                <div class="timeline-block">
                    <div class="panel panel-default">
                        ...
                        <img src="<?php echo base_url()?>site/images/place1-full.jpg" class="img-responsive">
                        <ul class="comments">
                            <li>
                                <div class="media">
                                    <a href="" class="pull-left">
                ...
                <div class="timeline-block">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="media">
                                <a href="" class="pull-left">
                                    <img src="<?php echo base_url()?>site/images/people/50/woman-4.jpg" class="media-object">
                                </a>
                                <div class="media-body">
                                    <a href="#" class="pull-right text-muted"><i class="icon-reply-all-fill fa fa-2x "></i></a>
                                    <a href="">Michelle</a>
                ...
                <div class="timeline-block">
                    <div class="panel panel-default profile">
                        <div class="cover-container">
                            <img src="<?php echo base_url()?>site/images/place1-full.jpg" alt="place" class="img-responsive" />
                        </div>
                        <div class="info">
                            <h4>Adrian Demian</h4>
                            <p>User Interface Designer</p>
                        </div>
                        <img src="<?php echo base_url()?>site/images/people/110/guy-6.jpg" alt="people" class="img-circle avatar" />
                ...
                <div class="timeline-block">
                    <div class="panel panel-default event">
                        ...
                        <ul class="list-unstyled attendees">
                            <li>
                                <a href="#">
                                    <img src="<?php echo base_url()?>site/images/people/110/guy-6.jpg" alt="people" class="img-responsive" />
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img src="<?php echo base_url()?>site/images/people/110/woman-3.jpg" alt="people" class="img-responsive" />
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img src="<?php echo base_url()?>site/images/people/110/guy-2.jpg" alt="people" class="img-responsive" />
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img src="<?php echo base_url()?>site/images/people/110/guy-9.jpg" alt="people" class="img-responsive" />
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img src="<?php echo base_url()?>site/images/people/110/woman-9.jpg" alt="people" class="img-responsive" />
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img src="<?php echo base_url()?>site/images/people/110/guy-4.jpg" alt="people" class="img-responsive" />
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img src="<?php echo base_url()?>site/images/people/110/guy-1.jpg" alt="people" class="img-responsive" />
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img src="<?php echo base_url()?>site/images/people/110/woman-4.jpg" alt="people" class="img-responsive" />
                                </a>
                            </li>
                            <li>
                                <a href="#">
                ...
                <div class="timeline-block">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="media">
                                <a href="" class="pull-left">
                                    <img src="<?php echo base_url()?>site/images/people/50/guy-2.jpg" class="media-object">
                                </a>
                                <div class="media-body">
                                    <a href="#" class="pull-right text-muted"><i class="icon-reply-all-fill fa fa-2x "></i></a>
                                    <a href="">Jonathan</a>
                            ...
                            <div class="boxed">
                                ...
                                <div class="media">
                                    <a href="#" class="media-object pull-left">
                                        <img src="<?php echo base_url()?>site/images/food1.jpg" alt="" width="80" />
                                    </a>
                                    <div class="media-body">
